...
DEFAULT_OUTPUT_STEM = "cus15_ppo_dde_gcbpo_e500_seed2005_val_obj"
DEFAULT_GUROBI_VAL = Path("/data/Maojie/Github2/Cus15/val/gurobi_summary.csv")

RUNS = [
    ("Vanilla PPO", "O2O_CUS15_PPO_VANILLA_NO_DDE_R40_U3_NE480_EB1000_EN8_E500", 2005, "#4c78a8"),
    ("PPO + DDE", "O2O_CUS15_PPO_DDE_R40_U3_NE480_EB1000_EN8_E500", 2005, "#59a14f"),
    ("GCBPO branch", "O2O_CUS15_GCBPO_BRANCH_DDE_R40_U3_NE480_EB1000_EN8_E500", 2005, "#e15759"),
    ("GCBPO branch + prefix", "O2O_CUS15_GCBPO_PREFIX_DDE_R40_U3_NE480_EB1000_EN8_E500", 2005, "#b07aa1"),
]
...
def main() -> None:
    ...
    ax.set_title("Cus15 PPO / DDE / GCBPO comparison (seed 2005)")
