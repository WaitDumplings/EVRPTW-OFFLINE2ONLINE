...
DEFAULT_OUTPUT_STEM = "cus15_dapg_vs_gadapg_u3_dde_seed2005_2006_val_obj"
DEFAULT_GUROBI_VAL = Path("/data/Maojie/Github2/Cus15/val/gurobi_summary.csv")

RUNS = [
    ("DAPG seed2005", "O2O_CUS15_DAPG_BASE_DYN_DDE_R40_U3_NE480_EB1000_EN8_E1000", 2005, "#2f6fbb"),
    ("DAPG seed2006", "O2O_CUS15_DAPG_BASE_DYN_DDE_R40_U3_NE480_EB1000_EN8_E1000", 2006, "#86b7e6"),
    ("GA-DAPG seed2005", "O2O_CUS15_GADAPG_GA03_DYN_DDE_R40_U3_NE480_EB1000_EN8_E1000", 2005, "#b23b3b"),
    ("GA-DAPG seed2006", "O2O_CUS15_GADAPG_GA03_DYN_DDE_R40_U3_NE480_EB1000_EN8_E1000", 2006, "#ee9a9a"),
]
...
def main() -> None:
    ...
    ax.set_title("Cus15 DAPG vs GA-DAPG (DDE, dynamic embedding)")
